...
static const char qt_meta_stringdata_netanim__StatsMode[] = {
    ...
    "statTypeChangedSlot(int)\0index\0"
    "updateTimelineSlot(int)\0value\0"
    "fontSizeSlot(int)\0clickFlowMonTraceFileOpenSlot()\0"
    "allowedNodesChangedSlot(QString)\0"
    "allowedNodes\0counterIndexChangedSlot(QString)\0"
    "counterString\0showChartSlot()\0"
};
